...
def init_bp(app):
    ...
    app.register_blueprint(card_blueprint, url_prefix=f'/{VERSION}/')
    app.register_blueprint(case_blueprint, url_prefix=f'/{VERSION}/')
    app.register_blueprint(board_blueprint, url_prefix=f'/{VERSION}/')
    app.register_blueprint(function_blueprint, url_prefix=f'/{VERSION}/')
    app.register_blueprint(milestone_blueprint, url_prefix=f'/{VERSION}/')
    app.register_blueprint(mantis_plan_blueprint, url_prefix=f'/{VERSION}/')
    app.register_blueprint(share_record_blueprint, url_prefix=f'/{VERSION}/')
    app.register_blueprint(mantis_common_blueprint, url_prefix=f'/{VERSION}/')
    app.register_blueprint(mantis_mapping_rule_blueprint, url_prefix=f'/{VERSION}/')
    app.register_blueprint(test_milestone_blueprint, url_prefix=f'/{VERSION}/')
    app.register_blueprint(test_cycle_blueprint, url_prefix=f'/{VERSION}/')
